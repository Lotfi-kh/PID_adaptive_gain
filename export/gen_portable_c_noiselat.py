...
ONNX_PATH = os.path.join(_ROOT, "results/frozen_joint_12d_noiselat/actor_joint_12d_noiselat.onnx")
OUT_DIR   = os.path.join(_HERE, "portable_c_noiselat")
...
def main():
    ...
    # ── rl_actor_weights.h ───────────────────────────────────────────────────
    h = ['/* AUTO-GENERATED from results/wind_retrain_1p4M/actor_joint_12d_wind1p4M.onnx — do not edit. */',
